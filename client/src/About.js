...
function About() {
  return (
    <div>
      ...
      <h3>How It Works:</h3>
      <p>
        Vandylifts is more than just a fitness club. It's a platform where seasoned trainers volunteer their time and expertise to train fellow students for free. Each trainee is paired with a dedicated trainer over multiple sessions, ensuring continuity and personalized attention. Whether you are a fitness novice or just looking for guidance to fine-tune your workouts, we're here for you. Please use our scheduling feature to match with a trainer, or our discussion page to view new announcements.
      </p>
